...
public class ItemFourFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        channelRV = (RecyclerView) getActivity().findViewById(R.id.type4);
        makeChannelRequest();
        ...
        channelRV.addItemDecoration(new ItemFourFragment.GridSpacingItemDecoration(3, dpToPx(10), true));
    ...
    private void makeChannelRequest(){
        ...
        JsonArrayRequest req = new JsonArrayRequest(Request.Method.GET, "http://neptube.codesastra.com/nepalyt/channellistJson.php?type=4", null, new Response.Listener<JSONArray>() {
            @Override
