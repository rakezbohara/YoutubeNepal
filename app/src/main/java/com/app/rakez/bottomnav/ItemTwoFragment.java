...
public class ItemTwoFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        channelRV = (RecyclerView) getActivity().findViewById(R.id.type2);
        makeChannelRequest();
        ...
        channelRV.addItemDecoration(new ItemTwoFragment.GridSpacingItemDecoration(3, dpToPx(10), true));
    ...
    private void makeChannelRequest(){
        ...
        JsonArrayRequest req = new JsonArrayRequest(Request.Method.GET, "http://neptube.codesastra.com/nepalyt/channellistJson.php?type=2", null, new Response.Listener<JSONArray>() {
            @Override
